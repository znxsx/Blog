...
<div class="container">
	...
	<div class="_nav ">
        	<ul>
        		<li class="_active"><a href="${pageContext.request.contextPath}/index.html"><strong>首页</strong></a></li>
        		<li><a href="${pageContext.request.contextPath}/show.html">项目展示</a></li> 
        		<li><a href="http://www.1ilm.cn">爱冷萌漫画网</a></li>
